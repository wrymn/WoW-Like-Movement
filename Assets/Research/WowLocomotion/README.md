...
> **EDUCATION ONLY:** Every script in this prototype was generated by AI. The code and architecture are ugly proof-of-concept work; the useful output is the independently measured behavior and tuning values, not the implementation quality.
